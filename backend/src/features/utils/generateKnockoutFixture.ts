...
export function buildKnockoutMatchData(
  ...
  const matchData: Prisma.MatchCreateInput = {
    ...
    ...(bracket.homeTeam.type === 'DIRECT' &&
      bracket.homeTeam.clubId && {
        homeClub: {
    ...
    ...(bracket.awayTeam.type === 'DIRECT' &&
      bracket.awayTeam.clubId && {
        awayClub: {
      ...
      bracket.homeTeam.sourcePosition && {
        homeSourceMatch: {
          connect: {
            ...
            id: matchIdMap.get(`${bracket.homeTeam.sourceRound}_${bracket.homeTeam.sourcePosition}`)!,
          },
        },
    ...
    ...(bracket.awayTeam.type === 'FROM_MATCH' &&
      ...
      bracket.awayTeam.sourcePosition && {
        awaySourceMatch: {
          connect: {
            id: matchIdMap.get(`${bracket.awayTeam.sourceRound}_${bracket.awayTeam.sourcePosition}`)!,
          },
        },
