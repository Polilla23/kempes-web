...
import { ICompetitionTypeRepository } from '../interfaces/ICompetitionTypeRepository'
import { CreateCompetitionTypeInput } from '../utils/types'

// Errors
import {
  CompetitionTypeAlreadyExistsError,
  CompetitionTypeNotFoundError,
} from '../errors/competitionType.errors'
