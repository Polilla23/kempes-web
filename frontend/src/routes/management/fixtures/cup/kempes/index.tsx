...
export const Route = createFileRoute('/management/fixtures/cup/kempes/')({
  component: KempesCupWizard,
})

function KempesCupWizard() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Copa Kempes - Fase de Grupos</h1>
        <p className="text-muted-foreground">Crea la fase de grupos de la Copa Kempes para equipos Mayores</p>
      </div>
...
export default KempesCupWizard
