...
function EditCompetitionForm({
  ...
  async function onSubmit(values: z.infer<typeof competitionSchema>) {
    try {
      ...
      const updateData: CompetitionFormData = {
        name: values.name,
      ...
      await CompetitionService.updateCompetition(competition.id, updateData)
  ...
  return (
    <Dialog open={!!competition} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Edit Competition</DialogTitle>
          <DialogDescription>
            Make changes to the competition here. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
