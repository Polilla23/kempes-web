    ...
    <div className="container mx-auto max-w-7xl p-6 space-y-6">
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        ...
        <div className="border-b bg-muted/50 px-6 py-4">
          <div className="grid grid-cols-[2fr,1fr,1.5fr,1.5fr,1.5fr,auto] gap-4 items-center">
        ...
        {Array.from({ length: rows }).map((_, index) => (
          <div key={index} className="px-6 py-3 border-b last:border-b-0">
            <div className="grid grid-cols-[2fr,1fr,1.5fr,1.5fr,1.5fr,auto] gap-4 items-center">
  ...
  return (
    <div className="container mx-auto max-w-7xl p-6 space-y-6">
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        {/* Table Header */}
        <div className="border-b bg-muted/50 px-6 py-4">
          <div className="grid grid-cols-[auto,2fr,2fr,1fr,auto] gap-4 items-center">
            <Skeleton className="h-3 w-12" />
            <Skeleton className="h-3 w-20" />
            <Skeleton className="h-3 w-16" />
            <Skeleton className="h-3 w-16" />
        ...
        {/* Table Rows */}
        {Array.from({ length: rows }).map((_, index) => (
          <div key={index} className="border-b last:border-b-0 px-6 py-3">
            <div className="grid grid-cols-[auto,2fr,2fr,1fr,auto] gap-4 items-center">
...
} // Table skeleton specifically for users list
  ...
  return (
    <div className="container mx-auto max-w-7xl p-6 space-y-6">
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        {/* Table Header */}
        <div className="border-b bg-muted/50 px-6 py-4">
          <div className="grid grid-cols-[2fr,1fr,1.5fr,1.5fr,auto] gap-4 items-center">
            <Skeleton className="h-3 w-16" />
            <Skeleton className="h-3 w-12" />
            <Skeleton className="h-3 w-16" />
            <Skeleton className="h-3 w-24" />
